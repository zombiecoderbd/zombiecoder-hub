...
For most use cases, try **Mistral**:
```bash
ollama pull mistral
```
...
| mistral | 7GB | ⚡ Medium | ⭐⭐⭐⭐ | `ollama pull mistral` |
| llama2 | 7GB | ⚡ Medium | ⭐⭐⭐⭐ | `ollama pull llama2` |
...
- Try: `ollama pull mistral --insecure`
- Clear cache: `ollama rm mistral` then retry
